...
const Home = () => {
  ...
  return (
    <div className="home">
      ...
      {/* Hero Section */}
      <section className="hero" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#F2F3F4' }}>
      ...
      <section id="about" style={{ backgroundColor: '#F2F3F4', position: 'relative', minHeight: '100vh' }}>
      ...
      {/* Skills Section */}
      <section id="skills" style={{ backgroundColor: '#F2F3F4' }}>
        <div className="container">
      ...
      {/* Projects Section */}
      <section id="projects" style={{ backgroundColor: '#F2F3F4' }}>
        <div className="container">
      ...
      {/* Experience Section */}
      <section id="experience" style={{ backgroundColor: '#F2F3F4' }}>
        <div className="container">
      ...
      {/* Education Section */}
      <section id="education" style={{ backgroundColor: '#F2F3F4' }}>
        <div className="container">
      ...
      {/* Contact Section */}
      <section id="contact" style={{ backgroundColor: '#F2F3F4' }}>
        <div className="container">
